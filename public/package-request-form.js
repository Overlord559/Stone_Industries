...
(function () {
  ...
  function mountModal() {
    ...
    modalEl.innerHTML =
      ...
      '<a class="cta cta-secondary" href="https://mail.google.com/mail/?view=cm&fs=1&to=edward@stoneindustriesusa.com&su=Stone%20Industries%20Package%20Request" target="_blank" rel="noopener noreferrer">Open Gmail</a>' +
      '</div>' +
      '<p class="si-copy-status" data-si-copy-status hidden aria-live="polite">Email copied.</p>' +
      '<a class="cta cta-secondary" data-si-package-mailto href="mailto:edward@stoneindustriesusa.com?subject=Stone%20Industries%20Package%20Request" hidden>Send this request via email</a>' +
      '</div>' +
      '</form>' +
      '</div>'
